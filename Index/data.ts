...
export const customerData: Record<number, any> = {
  1: {
    name: 'Rahul Sharma',
...
export const reportTabs = [
  ...
  { id: 'orders', label: 'Order Status Report' },
  { id: 'payment', label: 'Payment Report' }
]

export const salesReportData = [
  { date: '10 Feb 2026', orders: 25, revenue: '₹25,000', refund: '₹1,000' },
  { date: '09 Feb 2026', orders: 30, revenue: '₹32,500', refund: '₹500' },
  { date: '08 Feb 2026', orders: 22, revenue: '₹21,800', refund: '₹0' },
  { date: '07 Feb 2026', orders: 28, revenue: '₹29,400', refund: '₹1,200' },
  { date: '06 Feb 2026', orders: 35, revenue: '₹38,000', refund: '₹800' }
]

export const topProducts = [
  { name: 'Wireless Mouse', category: 'Electronics', units: 150, revenue: '₹1,19,850', stock: 25 },
  { name: 'Bluetooth Speaker', category: 'Electronics', units: 98, revenue: '₹1,46,902', stock: 5 },
  { name: 'Laptop Bag', category: 'Accessories', units: 75, revenue: '₹74,925', stock: 0 },
  { name: 'USB Cable', category: 'Accessories', units: 200, revenue: '₹39,800', stock: 150 },
  { name: 'Keyboard', category: 'Electronics', units: 65, revenue: '₹1,29,350', stock: 8 }
]

export const inventoryData = [
  { name: 'Wireless Mouse', sku: 'WM-001', stock: 25, threshold: 10, status: 'In Stock' },
  { name: 'Bluetooth Speaker', sku: 'BS-002', stock: 5, threshold: 10, status: 'Low Stock' },
  { name: 'Laptop Bag', sku: 'LB-003', stock: 0, threshold: 5, status: 'Out of Stock' },
  { name: 'USB Cable', sku: 'UC-004', stock: 150, threshold: 20, status: 'In Stock' },
  { name: 'Keyboard', sku: 'KB-005', stock: 8, threshold: 10, status: 'Low Stock' }
]

export const orderStatusData = [
  { orderId: '#ORD-1001', customer: 'Rahul Sharma', date: '10 Feb 2026', amount: '₹2,499', status: 'Delivered' },
  { orderId: '#ORD-1002', customer: 'Priya Singh', date: '10 Feb 2026', amount: '₹1,799', status: 'Shipped' },
  { orderId: '#ORD-1003', customer: 'Amit Kumar', date: '09 Feb 2026', amount: '₹3,299', status: 'Processing' },
  { orderId: '#ORD-1004', customer: 'Sneha Patel', date: '09 Feb 2026', amount: '₹999', status: 'Pending' },
  { orderId: '#ORD-1005', customer: 'Vikram Reddy', date: '08 Feb 2026', amount: '₹4,599', status: 'Cancelled' }
]

export const paymentData = [
  { orderId: '#ORD-1001', customer: 'Rahul Sharma', method: 'UPI', amount: '₹2,499', status: 'Paid', date: '10 Feb 2026' },
  { orderId: '#ORD-1002', customer: 'Priya Singh', method: 'Credit Card', amount: '₹1,799', status: 'Paid', date: '10 Feb 2026' },
  { orderId: '#ORD-1003', customer: 'Amit Kumar', method: 'COD', amount: '₹3,299', status: 'Pending', date: '09 Feb 2026' },
  { orderId: '#ORD-1004', customer: 'Sneha Patel', method: 'Debit Card', amount: '₹999', status: 'Pending', date: '09 Feb 2026' },
  { orderId: '#ORD-1005', customer: 'Vikram Reddy', method: 'UPI', amount: '₹4,599', status: 'Refunded', date: '08 Feb 2026' }
]
